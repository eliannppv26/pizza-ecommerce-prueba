...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    pizzas: Schema.Attribute.Relation<'oneToMany', 'api::pizza.pizza'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiComboCombo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::combo.combo'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    pizzas: Schema.Attribute.Relation<'manyToMany', 'api::pizza.pizza'>;
    products: Schema.Attribute.Relation<'manyToMany', 'api::product.product'>;
    promo_price: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    slug: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPizzaPizza extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    config: Schema.Attribute.Component<'pizza.customization', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crust: Schema.Attribute.Component<'pizza.pizza-crust-options', false>;
    description: Schema.Attribute.Text;
    image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    ...
    label: Schema.Attribute.Enumeration<['new', 'bestseller', 'promo']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::pizza.pizza'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    sizes: Schema.Attribute.Component<'pizza.size-price', true>;
    slug: Schema.Attribute.UID<'name'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.Enumeration<['drink', 'side', 'dessert']>;
    combos: Schema.Attribute.Relation<'manyToMany', 'api::combo.combo'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStoreConfigurationStoreConfiguration
  extends Struct.CollectionTypeSchema {
  collectionName: 'store_configurations';
  info: {
    displayName: 'Store-Configuration';
    pluralName: 'store-configurations';
    singularName: 'store-configuration';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    is_store_open: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::store-configuration.store-configuration': ApiStoreConfigurationStoreConfiguration;
